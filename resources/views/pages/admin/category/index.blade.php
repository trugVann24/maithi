    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <h2 class="text-lg font-medium text-gray-800 ">Danh sách danh mục</h2>
                <div class="flex items-center mt-4 gap-x-3">
                    <a href="{{route('admin.categories.create')}}" class="flex items-center justify-center w-1/2 px-5
                    py-2
                    text-sm
                    tracking-wide
                    text-white
                                    ...
                                    <tr>
                                        <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                            <div class="inline-flex items-center gap-x-3">
                                                <input type="checkbox" class="text-blue-500 border-gray-300 rounded "/>
                                                <div>
                                                    <p class="font-normal text-gray-800">{{__($category->id)}}</p>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">
                                            ...
                                            justify-center hover:text-blue-600">
                                                ...
                                                <form action="{{ route('admin.categories.destroy', $category->id) }}"
                                                      method="POST"
                                                      class="deleteForm" data-category-id="{{ $category->id }}">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="button" data-open-modal="deleteCategory"
                                                            data-category-id="{{ $category->id }}" class="w-9 h-9
