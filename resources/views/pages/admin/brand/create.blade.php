        ...
        <div class="rounded-md bg-white p-4">
            <div class="flex items-center justify-between">
                ...
                <div class="py-2">
                    ...
                    <p class="text-xs font-medium text-gray-600"><span class="text-red-500">(*)</span> bắt buộc phải nhập</p>
                </div>
            </div>
        </div>
        <div class="">
                        ...
                        <div class="mt-4">
                            <div>
                                ...
                                <textarea id="description"
                                          class="mt-2 w-full min-h-60 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                          type="text" name="description" value="{{old('description')}}" autofocus></textarea>
