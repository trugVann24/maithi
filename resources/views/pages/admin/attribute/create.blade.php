        ...
        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
            ...
            <div>
                <div class="mx-auto mt-10 max-w-xl rounded-md border p-4">
                    <form id="attributeForm" method="POST" action="{{ route('admin.products.store') }}">
                        @csrf
                        <div>
                        ...
                        <div id="optionsContainer" class="mt-3">
                            <div class="option relative">
                                ...
                                <x-text-input id="value" class="mt-1 block w-full" type="text"
                                              name="value[]"
                                              :value="old('value')" autofocus autocomplete="username"/>
                        ...
                        <div class="flex items-center justify-between">
                            <button type="button" id="addOption" class="mt-3 flex items-center justify-center w-1/2 px-5
                    py-2
                    text-sm
                    tracking-wide
                    text-white
