<footer class="bg-white ">
    <div class="container p-6 mx-auto">
        <div class="lg:flex">
            ...
            <div class="mt-6 lg:mt-0 lg:flex-1">
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    ...
                    <div>
                        <h3 class="text-gray-700 uppercase ">Chính sách</h3>
                        <a href="#" class="block mt-2 text-sm text-gray-600 hover:underline">Chính sách bảo hành</a>
                        <a href="#" class="block mt-2 text-sm text-gray-600 hover:underline">Chính sách giao hàng</a>
                        <a href="#" class="block mt-2 text-sm text-gray-600 hover:underline">Chính sách đổi trả</a>
                    </div>

                    <div>
                        <h3 class="text-gray-700 uppercase ">Liên hệ</h3>
                        <span class="block mt-2 text-sm text-gray-600 hover:underline">+84374407152</span>
                        <span class="block mt-2 text-sm text-gray-600 hover:underline">vannguyentrung@email.com</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div>
            <p class="text-center text-gray-500 ">© Van 2023 - All rights reserved</p>
        </div>
    </div>
</footer>
